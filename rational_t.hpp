...
// sobrecarga de los operadores de E/S (Escritura y lectura)
ostream& operator<<(ostream& os, const rational_t&);
istream& operator>>(istream& is, rational_t&);

// FASE I: operadores
// Es necesario sobrecargar estos operadores para poder utilizarlos comodamente en el main ( sumar, restar, ... )
